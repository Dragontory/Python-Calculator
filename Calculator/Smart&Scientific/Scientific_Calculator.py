...
filemenu.add_command(label="Scientifi")
...
def audio():
    mixer.music.load("C:\\Users\\toryy\\OneDrive\\Documents\\Visual Studio Code\\Project\\Smart&Scientific\\music1.mp3")
    mixer.music.play()
    ...
    with speech_recognition.Microphone()as m:
        try:
            ...
            mixer.music.load('C:\\Users\\toryy\\OneDrive\\Documents\\Visual Studio Code\\Project\\Smart&Scientific\\music2.mp3')
            mixer.music.play()
...
logoImage = PhotoImage(file='C:\\Users\\toryy\\OneDrive\\Documents\\Visual Studio Code\\Project\\Smart&Scientific\\logo.png')
...
micImage = PhotoImage(file='C:\\Users\\toryy\\OneDrive\\Documents\\Visual Studio Code\\Project\\Smart&Scientific\\microphone.png')
